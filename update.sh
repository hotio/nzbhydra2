...
(async () => {
  ...
  await page.evaluate(() => {
    ...
    div.style.cssText = "text-align: left; font-weight: normal; font-size: 20px; font-family: monospace; padding: 5px; color: white; position: fixed; bottom: 10px; right: 10px; background: DODGERBLUE; z-index: 10000";
